...
int main() {
    ...
    a.loadUserGraphsFromFile("C:\\Users\\maram\\OneDrive\\Desktop\\DS\\Wasalny Project\\users22.txt");
    User u1;
    int e = 0;
    FindPath f(a.get(userIndex).graph);
    while (e != 3)
    ...
    while ((c != 9) && (isTrue == true))
    {
        ...
        case 2: {
            ...
            a.get(userIndex).graph.addEdge(c1, c2, d, congested);
            break;
        ...
        case 3: {
            if (a.get(userIndex).graph.getGraph().empty())
                ...
                a.get(userIndex).graph.displayGraph();
            break;
        ...
        case 4: {
            ...
            cout << "Enter city: ";
            cin >> c;
            a.get(userIndex).graph.removeCity(c);
            break;
        }
        case 5: {
            string c1, c2;
            ...
            cout << "Enter scound city: ";
            cin >> c2;
            a.get(userIndex).graph.removeEdge(c1, c2);
            break;
        }
        case 6: {
            if (a.get(userIndex).graph.getGraph().empty())
                ...
                t.traverse(a.get(userIndex).graph.getGraph());
            break;
        }
        case 7: {
            if (a.get(userIndex).graph.getGraph().empty())
    ...
    a.saveUserGraphsToFile("C:\\Users\\maram\\OneDrive\\Desktop\\DS\\Wasalny Project\\users22.txt");
